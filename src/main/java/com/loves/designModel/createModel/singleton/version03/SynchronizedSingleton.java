...
/**
 *
 * volatile 相关知识： http://www.cnblogs.com/dolphin0520/p/3920373.html
...
// 然后又从B取出了500元，取出500元之后，再执行 往账户B加上1000元 的操作。这样就会导致账户A虽然减去了1000元，
...
// 而此是线程2会以为初始化工作已经完成，那么就会跳出while循环，去执行doSomethingwithconfig(context)方法，而此时context并没有
// 被初始化，就会导致程序出错。
